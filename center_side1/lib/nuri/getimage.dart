...
class DisplayPictureScreen extends StatefulWidget {
  ...
  const DisplayPictureScreen({Key? key, required this.imageAnalysed}) : super(key: key);
...
class _DisplayPictureScreenState extends State<DisplayPictureScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    return isLoading ? CircularProgressIndicator() : SizedBox(height:100,width: 100,child: Image.file(fileImg));
  }
}
